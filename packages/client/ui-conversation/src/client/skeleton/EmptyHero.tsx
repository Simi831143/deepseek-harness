...
import {
  IconChevronDownOutlineRegular, IconFolderCloseRegular, IconFolderOpenRegular, LongcheerMark,
...
/**
 * The hero product mark, sized like the artwork it replaces. Decorative —
 * hidden from the accessibility tree.
 * @returns the mark element.
 */
function HeroMark() {
  return <LongcheerMark size={34} className={css.fish} />
}
