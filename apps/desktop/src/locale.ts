...
export const en = {
  ...
  startupFailed: 'LongCheer Agent could not start',
  startupLoading: 'Starting LongCheer Agent…',
...
export const zh = {
  application: '应用',
  startupFailed: 'LongCheer Agent 无法启动',
  startupLoading: '正在启动 LongCheer Agent…',
  ...
  updateTitle: 'LongCheer Agent 更新',
  ...
  pluginWindowTitle: 'LongCheer Agent — 桌面插件',
