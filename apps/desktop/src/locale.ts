...
export const en = {
  ...
  aboutMenu: 'About LongCheer Agent',
  aboutProduct: 'LongCheer Agent',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide LongCheer Agent',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit LongCheer Agent',
  edit: 'Edit',
  ...
  startupFailed: 'LongCheer Agent is unavailable',
  ...
  welcomeTitle: 'LongCheer Agent',
  welcomeBrand: 'LongCheer Agent',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'LongCheer Agent',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'LongCheer Agent v{version} downloaded',
  ...
  updateDetail: 'LongCheer Agent {version}\n\nLongCheer Agent will restart to complete the update.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 LongCheer Agent',
  aboutProduct: 'LongCheer Agent',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 LongCheer Agent',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 LongCheer Agent',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'LongCheer Agent 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'LongCheer Agent v{version} 下载完成',
